  ...
  return (
    <GlassCard title="Sign in">
      <StyledDescriptionTypography className="text-lg mt-4">
        Log in to begin managing your Med-Aesthetics journey with ease!
      </StyledDescriptionTypography>
      <StyledLoginInput
      ...
      <StyledLoginButton variant="contained" size="large">
        Login
      </StyledLoginButton>
      <Box
      ...
      >
        ...
        <StyledCreateAccButton size="small">Sign Up</StyledCreateAccButton>
      </Box>
    </GlassCard>
  );
};
